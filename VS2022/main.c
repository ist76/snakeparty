...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow)
{
     ...
     HWND hwnd = CreateWindowW(L"mainwin", "Snake Party", 0x100A0000, 10, 10,
                              (AllActors.LevelWin.x + ScoreTable.right + 2 * gsets.scale),
                              (AllActors.LevelWin.y + 3 * gsets.scale), NULL, NULL, NULL, NULL);
